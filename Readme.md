...
- [x]  Codificacion de proyecto en C++
    - [x]  Floyd
    - [x]  Prim
- [x]  Informe del proyecto
...
1. Creacion de la clase Grafo
    ...
    ![Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_1.png](Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_1.png)
    ...
    - `void add_arista(int i, j ,weight)` → Funcion vacia que creara las relaciones de nuestros grafo, una matriz de adyecencia.
...
![Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_3.png](Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_3.png)

3. Matriz de adyecencia → `void add_arista(int i, j ,weight)`

La variable miembro `matriz` una variable que es una matriz de adyecencia de dos dimensiones.

![Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_4.png](Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_4.png)

---

4. Algoritmo de wharsall → `void Grafo::floyd_warshall()`

![Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_2.png](Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_2.png)
...
2. Segundo condicional → `(matriz[i][j] > matriz[i][k] + matriz[k][j])`
    ...
    ***Entonces,*** el valor de la `ruta[i][j]` actualizara el valor con la suma de `ruta[i][k]` y `ruta[k][j]` .Por ultimo `ruta[i][j]` tomara el valor de `ruta[i][k]`
...
1. Primer condicional → `if (i != j && matriz[i][j] == 0)` 
    ...
    Si en nuestra matriz de adyecencia esta en la diagonal principal o si el valor de la posicion de nuestra matriz `matriz[i][j]` es 0.
...
2. Segundo condicional → `if (matriz[i][j] == INF)`
    ...
    ***Entonces,*** el valor de la `ruta[i][j]` tomara un valor infinito `-1` que indicara que la ruta no exite para `ruta[i][j]`
...
![Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_5.png](Proyecto%20EL%20VIAJERO%203f1bfb60c8444d6cae89037537f27cb0/code_5.png)
...
2. `cambio` incrementa
3. longitud se actualiza con el valor de la matriz de adyecencia minima.
